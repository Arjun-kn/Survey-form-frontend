  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        <div
          style={{ backgroundColor: "white", width: "60px", height: "40px" }}
        >
          <div className="sidebar-icon" style={{ textAlign: "center" }}>
            <img
              src={community}
              alt="community icon"
              style={{ width: "30px", height: "26px", marginTop: "6px" }}
            />
          </div>
        </div>
        <div className="sidebar-icon">
          <img
            ...
            className="menu-icon"
            alt="menubar"
            style={{ marginTop: "25px", width: "30px", height: "30px" }}
          />
        </div>
      </div>
          ...
          <div className="user">
            ...
            {showDropdown && (
              <div className="dropdown">
                <ul>
                  <li onClick={handleLogout} className="log">
                    Logout
                  </li>
                </ul>
              </div>
